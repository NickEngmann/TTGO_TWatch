...
- *2026-03-06* — Implement: Improve: BatteryManager.h, BatteryManager.cpp, test_battery_manager.cpp
- *2026-03-06* — Implement: Improve: ci.yml, BatteryManager.h, BatteryManager.cpp (+2 more)
- *2026-03-06* — Implement: implemented the main application state machine for the TTGO TWatch project.
